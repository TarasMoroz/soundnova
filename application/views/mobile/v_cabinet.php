...
<body id="home">
	...
	<div id="cabinet" class="cont">
		...
		<div class="cab-col">
			<div class="cab-col-row"> <a href="#">Редактировать профиль</a> <a href="#">Поменять пароль</a> </div>
	...
	<div class="cont">
		...
		<? for ($i=0; $i < 3; $i++): ?>
		<div class="cab-order <?=($i==0?'cab-order-act':'')?>">
			<h3 class="cab-order-title">Заказ №1234<?=$i?> <i class="darrsvg"></i></h3>

			<div class="cab-order-wrap">
