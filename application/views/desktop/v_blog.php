...
<body id="home">
    ...
    <div class="full-width-container blog-main-container">
				...
				<div class="blog-container">
					<div class="blog-content-container">
						<div class="posts-grid-item">
							<div class="title-links">
								<h2 class="container-title secondary-title">
									<div class="gradient-title">News & Updates</div>
								</h2>
								<a href="#" class="category-link">All articles of this categories</a>
							</div>
						...
						<div class="posts-grid-item">
							<div class="title-links">
								<h2 class="container-title secondary-title">
									<div class="gradient-title">Filmmaking & post-production</div>
								</h2>
								<a href="#" class="category-link">All articles of this categories</a>
							</div>
							<div class="category-posts-mobile">
						...
						<div class="posts-grid-item">
							<div class="title-links">
								<h2 class="container-title secondary-title">
									<div class="gradient-title">Post-audio & sound design</div>
								</h2>
								<a href="#" class="category-link">All articles of this categories</a>
							</div>
							<div class="category-posts-mobile">
		...
		<div class="full-width-container blog-instagram-container">
			<div class="inner-content-container">
				<h2 class="container-title secondary-title">
