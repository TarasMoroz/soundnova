...
<div class="product-top-container full-width-container" id="product1">
	<div class="product-top-inner-content inner-content-container">
		<div class="product-top-mobile">
			...
			<div class="product-top-info-container bundle">
				<div class="left-col" <? if(isset($prodVariants['design']) && isset($prodVariants['construct'])): ?>class="edition"<? endif; ?>>
					...
					<div class="main-pack-slider-container">
								...
								magic bundle included 12 packages
								</div>
						...
						<div class="you-save-block"> you save <span>$550</span></div>
				</div>
				<div class="right-col">
			...
			<div class="product-top-info-container bundle">
				<div class="left-col" <? if(isset($prodVariants['design']) && isset($prodVariants['construct'])): ?>class="edition"<? endif; ?>>
					...
					<div class="main-pack-slider-container">
								...
								<div class="main-pack-slider">
										<!-- Swiper -->
									<div class="swiper-container desktop-bundle-wrapper">
										<div class="swiper-wrapper">
											<div class="swiper-slide"><a href="#"><img class="lzy_img" data-src="../assets/img/packs/packs-bundle-1.svg"/>Product name</a></div>
											<div class="swiper-slide"><a href="#"><img class="lzy_img" data-src="../assets/img/packs/packs-bundle-2.svg"/>Product name</a></div>
											<div class="swiper-slide"><a href="#"><img class="lzy_img" data-src="../assets/img/packs/packs-bundle-1.svg"/>Product name</a></div>
