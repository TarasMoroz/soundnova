...
<div id="product1" style="background-image:url('<?=($mainVariant['img_bg']?'/assets/media/product_variant-img_bg/'.$mainVariant['img_bg']:'/assets/img/product1-bg.jpg')?>');">
	<div class="inner1530">
		<div id="product1-inner">
			<div id="product1-left">
				<div id="product1-left-top" class="bundle">
					<div class="bundle-sale">
						...
						<? 
							$im = '/assets/img/default_bundle_open.png';
						...
						<img id="product-top-box" src="<?=$im?>" alt="<?=$product['name']?>">
					</div>	
				</div>
