...
//$client->setDeveloperKey('AIzaSyB1ZMq4w3ZuMJsj6Tn2R7bTkHnLEAOLT3c'); //GET AT AT DEVELOPERS.GOOGLE.COM
$client->setDeveloperKey('AIzaSyDu1ri5QOpzr0bJoSwkOHQ60hIKhrr1KX0'); //GET AT AT DEVELOPERS.GOOGLE.COM = = my key !!!!
...
//$calendarId = 'tarik_alka@mail.ru';
$calendarId = 'spasinnya@gmail.com';
//$calendarId = 'golovash88@gmail.com';
...
?>">
        ...
        <br>
        <?php echo $event->description; //SUMMARY = TITLE ?>
    </div>
    </div>
 <?php
  }
